...
call %SCRIPTS_HOME%\.win\require-var H2_HOME
call %SCRIPTS_HOME%\.win\require-var H2_WEB_PORT
call %SCRIPTS_HOME%\.win\require-var H2_REQUIRED_JDK
...
call %SCRIPTS_HOME%\dev\setup-jdk "%H2_REQUIRED_JDK%"
