...
rem Usage in script:
rem   call %SCRIPTS_HOME%\.win\source-file <file>
...
set __source_file_bat="%SCRIPTS_TEMP_DIR%\source-file-%__source_file_tag%.bat"

more "%__file%" > "%__source_file_bat%"

endlocal & call "%__source_file_bat%" & if exist "%__source_file_bat%" del "%__source_file_bat%"
